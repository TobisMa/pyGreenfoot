...
from pygreenfoot.templates.init_actor import InitActor


class MyWorld(World):
    def __init__(self):
        World.__init__(self, 50, 50, 40)
...
class MA2(InitActor):
    def __init__(self):
        InitActor.__init__(self, image=Image.from_filename("hase.png"))
